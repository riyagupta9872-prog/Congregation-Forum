...
async function openHistoryModal() {
  ...
  try {
    ...
    const labels = { name:'Name', mobile:'Mobile', chanting_rounds:'Chanting Rounds', kanthi:'Kanthi', vaishnav_dress:'Vaishnav Dress', team_name:'Team', devotee_status:'Status', facilitator:'Facilitator', reference_by:'Reference', calling_by:'Calling By', gender:'Gender', marriage_anniversary:'Marriage Anniversary', created:'Registered', is_not_interested:'Not Interested', calling_mode:'Calling Mode' };
