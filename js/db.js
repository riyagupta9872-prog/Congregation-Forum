...
function toSnake(d) {
  ...
  return {
    ...
    dob:                 d.dob || null,
    date_of_marriage:    d.dateOfMarriage || null,
...
function toCamel(f) {
  return {
    ...
    dob:               f.dob || null,
    dateOfMarriage:    f.date_of_marriage || null,
      ...
      chunk.forEach((row, i) => {
        ...
        try {
          ...
          const payload = {
            ...
            dateOfMarriage:   importDate(importCol(row, ['Date of Marriage','Marriage Date','DOM','Anniversary','dom','Marriage'])) || null,
